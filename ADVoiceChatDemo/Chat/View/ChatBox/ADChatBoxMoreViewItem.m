...
@interface ADChatBoxMoreViewItem ()
...
@implementation ADChatBoxMoreViewItem
 ...
 *  @return item
 */
+ (ADChatBoxMoreViewItem *) createChatBoxMoreItemWithTitle:(NSString *)title imageName:(NSString *)imageName {
    ADChatBoxMoreViewItem *item = [[ADChatBoxMoreViewItem alloc] init];
    item.title = title;
