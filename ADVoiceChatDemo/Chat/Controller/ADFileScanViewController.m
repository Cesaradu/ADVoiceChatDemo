...
@interface ADFileScanViewController () <QLPreviewControllerDataSource, QLPreviewControllerDelegate, UIWebViewDelegate, UIDocumentInteractionControllerDelegate>

@property (nonatomic, weak) UIWebView *webView;
@property (nonatomic, strong) QLPreviewController *previewController;
@property (nonatomic, strong) NSURL *fileURL;
@property (nonatomic, strong) UIDocumentInteractionController *documentInCtr;
@property (nonatomic, weak) ADAudioView *audioView;

@end

@implementation ADFileScanViewController
...
- (void)setupVew:(NSString *)type {
    if ([type isEqualToString:@"html"] || [type isEqualToString:@"htm"]) {
        UIWebView *webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, self.view.width,ScreenHeight)];
        ...
        ADAudioView *audioView = [[ADAudioView alloc] initWithFrame:self.view.bounds];
...
- (void)makeOtherView {
    ...
    nameL.textColor     = ADRGB(0x505f62);
    ...
    label.textColor = ADRGB(0xbebebe);
